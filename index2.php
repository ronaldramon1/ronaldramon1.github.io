...
<div class="slider owl-carousel">
        ...
        <!--1-->
        <div class="col-md-3" style="margin-right:40px;margin-left:-5em">

        <div class="card2 " style="padding: 10px 20px;background-image: url(assets/img/Propiedades/Blumarina2.jpg);background-size: cover;z-index: 22;">
        ...
        <div class="content" style="margin-left:-1.5em;" >
                <div class="title">EXCLUSIVO COMPLEJO DE APARTAMENTOS</div>
                <p style="font-weight: 300;margin-top:0.5em;"><i class="glyphicon glyphicon-bed"></i> 1 <i class="  bi bi-rulers"></i> 79.47 mts² <i class=" fa-solid fa-bath"></i> 2 baños</p>
			...
			<div class="favorito" style="margin-left: 17em;">
        <a target="_blank" href="https://api.whatsapp.com/send/?phone=18095555555&text&app_absent=0" ><i class="text-white h2 bi bi-heart"></i></a>
        </div>
        <div class="localizacion" style="margin-top:-11em;margin-left:0em;">
        <p style="font-family:Poppins;font-size:16px;font-weight: 300;"><i class="bi bi-geo-alt" style="position: absolute;margin-top: 3.5px;margin-left: -15px;"></i>Punta Cana</p>
    </div>
        </div>       
        </div>
...
<div class="content" style="margin-left:-1.5em;" >
        <div class="title">EXCLUSIVO COMPLEJO DE APARTAMENTOS</div>
        <p style="font-weight: 300;margin-top:0.5em;margin-left:0.5em"><i class="glyphicon glyphicon-bed"></i> 1 <i class="  bi bi-rulers"></i> 79.47 mts² <i class=" fa-solid fa-bath"></i> 2 baños</p>
        <p style="font-weight:300; margin-top:-1px">Desde<strong> US$ 236,499.00</strong></p>
        <div class="btn">
...
<div class="localizacion" style="margin-top:-11em;margin-left:0em;">
		...
		<!--Glider JS=====================================-->
		<script type="text/javascript" src="css/glider.min.js"></script>
